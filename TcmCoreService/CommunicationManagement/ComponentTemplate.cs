...
namespace TcmCoreService.CommunicationManagement
{
    ...
    public class ComponentTemplate : Template, IWorkflowItem
    {
        ...
        /// <summary>
        /// Gets or sets related <see cref="I:System.Collections.Generic{Schema}" /> <see cref="T:TcmCoreService.Misc.TcmUri" /> for this <see cref="ComponentTemplate" />
        /// </summary>
        /// <value>
        /// Related <see cref="I:System.Collections.Generic{Schema}" /> <see cref="T:TcmCoreService.Misc.TcmUri" /> for this <see cref="ComponentTemplate" />
        /// </value>
        public IEnumerable<TcmUri> RelatedSchemasUris
        {
            get
            {
                return mComponentTemplateData.RelatedSchemas.Select(schema => new TcmUri(schema.IdRef));
            }
            set
            {
                mRelatedSchemas = null;
        ...
        /// <summary>
        /// Gets or sets tracking <see cref="I:System.Collections.Generic{Category}" /> <see cref="T:TcmCoreService.Misc.TcmUri" /> for this <see cref="ComponentTemplate" />
        /// </summary>
        /// <value>
        /// Tracking <see cref="I:System.Collections.Generic{Category}" /> <see cref="T:TcmCoreService.Misc.TcmUri" /> for this <see cref="ComponentTemplate" />
        /// </value>
        public IEnumerable<TcmUri> TrackingCategoriesUris
        {
            get
            {
                return mComponentTemplateData.TrackingCategories.Select(category => new TcmUri(category.IdRef));
            }
            set
            {
                mTrackingCategories = null;
